...
public class user extends javax.swing.JFrame {
    ...
    ResultSet RsPeminjam = null;
    private String No_TransPeminjaman,id_pelanggan,nama_pelanggan;
...
private void auto(){
 try {
            ...
            while (Rsauto.next()) {
                if (Rsauto.first() == false) {
                    txtCariData.setText("PMJMN/000001");
                } else {
                    Rsauto.last();
 ...
 JasperReport jasper;
    ...
    private void tampilData() {
        try {
            Object[] judul_kolom = {"No_TransPeminjaman", "tanggalPeminjaman", "id_pelanggan",
                "Nama Pelanggan", "Alamat" ,"No_Hp","Sewa","Jumlah total", "Bayar DP", "Sisa Bayar"};
            tabModel = new DefaultTableModel(null, judul_kolom);
            jTabelPeminjam.setModel(tabModel);
            Con = (Connection) koneksi.connect();
            stt = Con.createStatement();
            tabModel.getDataVector().removeAllElements();
            RsPeminjam = stt.executeQuery("SELECT * FROM `tb_peminjaman` JOIN det_peminjaman ON "
                    + "tb_peminjaman.No_TransPeminjaman = det_peminjaman.No_TransPeminjaman ");
            while (RsPeminjam.next()) {
                Object[] data = {
                    RsPeminjam.getString("No_TransPeminjaman"),
                    RsPeminjam.getString("tanggalPeminjaman"),
                    RsPeminjam.getString("id_pelanggan"),
                    RsPeminjam.getString("Nama_pelanggan"),
                    RsPeminjam.getString("alamat"),
                    RsPeminjam.getString("No_Hp"),
                    RsPeminjam.getString("Jenis_alat"),
                    RsPeminjam.getString("jmlh_total"),
                    RsPeminjam.getString("bayar_Dp"),
                    RsPeminjam.getString("sisa_bayar")
                };
    ...
    private void cariData(String key) {
        try {
            Object[] judul_kolom = {"No_TransPeminjaman", "tanggalPeminjaman", "id_pelangan", "No Type", "NIK", "Nama Karyawan",
                "Nama Pelanggan", "Jenis sewa", "Warna", "HargaUnit","Jumlah",
                "jmlh_hari", "jmlh_total", "Bayar DP", "Sisa Bayar"};
            tabModel = new DefaultTableModel(null, judul_kolom);
            jTabelPeminjam.setModel(tabModel);
            ...
            RsPeminjam = stt.executeQuery("SELECT * from `tb_peminjaman` WHERE "
                    + " No_TransPeminjaman = '" + key + "'");
            while (RsPeminjam.next()) {
                Object[] data = {
                    RsPeminjam.getString("No_TransPeminjaman"),
                    RsPeminjam.getString("tanggalPeminjaman"),
                    RsPeminjam.getString("id_pelanggan"),
                    RsPeminjam.getString("No_type"),
                    RsPeminjam.getString("NIK"),
                    RsPeminjam.getString("Nama_karyawan"),
                    RsPeminjam.getString("Nama_pelanggan"),
                    RsPeminjam.getString("Jenis_alat"),
                    RsPeminjam.getString("Warna"),
                    RsPeminjam.getString("HargaUnit"),
                    RsPeminjam.getString("Jumlah"),
                    RsPeminjam.getString("jmlh_hari"),
                    RsPeminjam.getString("jmlh_total"),
                    RsPeminjam.getString("bayar_Dp"),
                    RsPeminjam.getString("sisa_bayar")
                };
    ...
    private void Hapus1() {
        No_TransPeminjaman = txtCariData.getText();
        id_pelanggan = jTextID.getText();
        nama_pelanggan = jTextnama.getText();
        try {
            stt.executeUpdate("DELETE FROM tb_peminjaman WHERE No_TransPeminjaman='" + No_TransPeminjaman + "'");
    ...
    private void initComponents() {
        ...
        jTabelPeminjam = new javax.swing.JTable();
        ...
        jLabel9.setText("Transaksi Peminjaman");
        ...
        jLabel4.setText("No TransPeminjaman :");

        jTabelPeminjam.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTabelPeminjam.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jTabelPeminjamMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(jTabelPeminjam);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextnama, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE))
                        .addGap(191, 191, 191)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jButton11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
            try{
            jasdes = JRXmlLoader.load("src/iReport/StrukTransaksi.jrxml");
            param.put("No_TransPeminjaman", txtCariData.getText());
    ...
    private void txtCariDataKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariDataKeyReleased
        ...
        if (enter == 10) {
            ...
            try {
                ...
                + "WHERE No_TransPeminjaman='" + txtCariData.getText() + "'";
                stt = Con.createStatement();
                RsTransaksi = stt.executeQuery(sql);
                boolean ada = RsTransaksi.next();
                if(ada){
                   jTextID.setText(RsTransaksi.getString(4));
                    jTextnama.setText(RsTransaksi.getString(8));
                }
            }catch (Exception e) {
    ...
    private void jTabelPeminjamMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelPeminjamMousePressed
        // TODO add your handling code here:
        auto();
        if (evt.getClickCount() == 1) {
            txtCariData.setText(String.valueOf(jTabelPeminjam.getValueAt(jTabelPeminjam.getSelectedRow(), 0)));
            jTextID.setText(String.valueOf(jTabelPeminjam.getValueAt(jTabelPeminjam.getSelectedRow(), 2)));
            jTextnama.setText(String.valueOf(jTabelPeminjam.getValueAt(jTabelPeminjam.getSelectedRow(), 3)));
        }
    }//GEN-LAST:event_jTabelPeminjamMousePressed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        try{
           File Report = new File ("src/iReport/StrukTransaksiAll.jasper");
    ...
    private javax.swing.JTable jTabelPeminjam;
